            ...
            while (ss >> word)
            {
                if (word == "vertex" || word == "normal")
                {
                    ...
                    for (int i = 0; i < 3; i++)
                    {
                        ...
                        /*if (word == "vertex")
                        {
                            double x = triangulation.uniqueNumbers[triangulation.uniqueNumbers[xyz[0]]];
                            double y = triangulation.uniqueNumbers[triangulation.uniqueNumbers[xyz[1]]];
                            double z = triangulation.uniqueNumbers[triangulation.uniqueNumbers[xyz[2]]];
